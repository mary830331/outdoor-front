<template>
  <q-layout view="lHh Lpr lff"  >
    <q-header  class="q-mt-xl text-blue-grey-10 bg " >
      <div class="bg-000"></div>
      <q-toolbar class="q-pt-10">
          <q-item to="/" ><img  style="width: 185px;" src="../../src/assets/nomadgo-w-01.png" ></q-item>
        <q-item-section class="menu-list">
          <q-list class="row">
            <q-item to="/">
              <q-item-section >
                首頁
        ...
        <div side class="row avatar">
          <q-item>
            <q-avatar size="50px" to="/admin">
          <img :src='user.image'>
